...
// Fast models first — 550B/120B need 60-90s so put them last
// Timeout 90s — safe on Render (no server limit)
const MODELS = [
  'openai/gpt-oss-20b:free',                // 20B — fastest
  'nvidia/nemotron-3-nano-30b-a3b:free',    // 30B — fast fallback
  'google/gemma-4-31b-it:free',             // 31B — reliable
  'nvidia/nemotron-3-super-120b-a12b:free', // 120B — slower but strong
  'nvidia/nemotron-3-ultra-550b-a55b:free', // 550B — slowest, best quality
];
